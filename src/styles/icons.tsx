...
export function Icons (props: {
  ...
  let home = (
    <>
      ...
      <rect
        ...
        height='5.13197'
        rx='2'
        transform='matrix(1 0 0 -1 7.875 13.0919)'
        fill={props.colors[0]}
        fillOpacity='0.4'
      />
      <rect
      ...
      <rect
        ...
        height='5.13196'
        rx='2'
        transform='matrix(1 0 0 -1 15.75 5.39392)'
        fill={props.colors[0]}
        fillOpacity='0.4'
      />
      <rect
        ...
        height='5.13197'
        rx='2'
        transform='matrix(1 0 0 -1 15.75 13.0919)'
        fill={props.colors[0]}
        fillOpacity='0.4'
      />
      <rect
        ...
        height='5.13196'
        rx='2'
        transform='matrix(1 0 0 -1 15.75 20.7898)'
        fill={props.colors[0]}
        fillOpacity='0.4'
      />
    </>
  ...
  let info = (
    <>
      <g>
        <path
          fill='rgba(0,0,0,0)'
          d='M14.5001 1.60889C7.00331 1.60889 0.924561 7.59412 0.924561 14.9756C0.924561 22.357 7.00331 28.3423 14.5001 28.3423C21.9969 28.3423 28.0757 22.357 28.0757 14.9756C28.0757 7.59412 21.9969 1.60889 14.5001 1.60889V1.60889Z'
          stroke={props.colors[0]}
          strokeOpacity='0.4'
          strokeWidth='2'
          strokeMiterlimit='8'
        ...
        <path
          fill='rgba(0,0,0,0)'
          d='M12.4343 12.9415H14.7953V21.3684'
          stroke={props.colors[0]}
          strokeOpacity='0.4'
          strokeWidth='2'
          strokeMiterlimit='8'
  ...
  let plus = (
    <>
      <path
        d='M7.11621 11.6431H10.8179V14.3193H7.11621V18.5029H4.29639V14.3193H0.584473V11.6431H4.29639V7.63379H7.11621V11.6431Z'
        fill={props.colors[0]}
        fillOpacity='0.8'
      />
    </>
  ...
  let loading = (
    <>
      <circle fill={props.colors[0]} stroke='none' cx='6' cy='50' r='6'>
        <animateTransform
      ...
      <circle fill={props.colors[0]} stroke='none' cx='30' cy='50' r='6'>
        <animateTransform
          attributeName='transform'
          dur='1s'
          type='translate'
      ...
      <circle fill={props.colors[0]} stroke='none' cx='54' cy='50' r='6'>
        <animateTransform
          attributeName='transform'
          dur='1s'
          type='translate'
  ...
  if (props.icon == 'home') {
    iconContent = home
  } else if (props.icon == 'actions') {
    iconContent = actions
  } else if (props.icon == 'info') {
    iconContent = info
  } else if (props.icon == 'plus') {
    iconContent = plus
  } else if (props.icon == 'loading') {
    iconContent = loading
  } else {
    iconContent = info
  }
